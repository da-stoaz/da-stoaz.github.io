import{V as $,X as x,ak as T,af as l,ax as m,aW as w,a$ as p,a1 as u,av as L,ad as P,c,o as d,g as f,F as v,h as B,e as h,ai as F,j as g,y as C,E as I,t as M}from"./DqA0wvgn.js";var D=({dt:e})=>`
.p-tabmenu {
    overflow-x: auto;
}
...
`,K={root:"p-tabmenu p-component",tablist:"p-tabmenu-tablist",item:function(t){var n=t.instance,r=t.index,s=t.item;return["p-tabmenu-item",{"p-tabmenu-item-active":n.d_activeIndex===r,"p-disabled":n.disabled(s)}]},itemLink:"p-tabmenu-item-link",itemIcon:"p-tabmenu-item-icon",itemLabel:"p-tabmenu-item-label",activeBar:"p-tabmenu-active-bar"},E=$.extend({name:"tabmenu",style:D,classes:K}),N={name:"BaseTabMenu",extends:T,props:{model:{type:Array,default:null},activeIndex:{type:Number,default:0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:E,provide:function(){return{$pcTabMenu:this,$parentInstance:this}}},S={name:"TabMenu",extends:N,inheritAttrs:!1,emits:["update:activeIndex","tab-change"],data:function(){return{d_activeIndex:this.activeIndex}},watch:{activeIndex:{flush:"post",handler:function(t){this.d_activeIndex=t,this.updateInkBar()}}},mounted:function(){var t=this;this.$nextTick(function(){t.updateInkBar()});var n=this.findActiveItem();n&&(n.tabIndex="0")},updated:function(){this.updateInkBar()},methods:{getPTOptions:function(t,n,r){return this.ptm(t,{context:{item:n,index:r}})},onItemClick:function(t,n,r){if(this.disabled(n)){t.preventDefault();return}n.command&&n.command({originalEvent:t,item:n}),r!==this.d_activeIndex&&(this.d_activeIndex=r,this.$emit("update:activeIndex",this.d_activeIndex)),this.$emit("tab-change",{originalEvent:t,index:r})},onKeydownItem:function(t,n,r){switch(t.code){case"ArrowRight":{this.navigateToNextItem(t.target),t.preventDefault();break}case"ArrowLeft":{this.navigateToPrevItem(t.target),t.preventDefault();break}case"Home":{this.navigateToFirstItem(t.target),t.preventDefault();break}case"End":{this.navigateToLastItem(t.target),t.preventDefault();break}case"Space":case"NumpadEnter":case"Enter":{this.onItemClick(t,n,r),t.preventDefault();break}case"Tab":{this.onTabKey();break}}},navigateToNextItem:function(t){var n=this.findNextItem(t);n&&this.setFocusToMenuitem(t,n)},navigateToPrevItem:function(t){var n=this.findPrevItem(t);n&&this.setFocusToMenuitem(t,n)},navigateToFirstItem:function(t){var n=this.findFirstItem(t);n&&this.setFocusToMenuitem(t,n)},navigateToLastItem:function(t){var n=this.findLastItem(t);n&&this.setFocusToMenuitem(t,n)},findNextItem:function(t){var n=t.parentElement.nextElementSibling;return n?m(n,"data-p-disabled")===!0?this.findNextItem(n.children[0]):n.children[0]:null},findPrevItem:function(t){var n=t.parentElement.previousElementSibling;return n?m(n,"data-p-disabled")===!0?this.findPrevItem(n.children[0]):n.children[0]:null},findFirstItem:function(){var t=u(this.$refs.nav,'[data-pc-section="item"][data-p-disabled="false"]');return t?t.children[0]:null},findLastItem:function(){var t=L(this.$refs.nav,'[data-pc-section="item"][data-p-disabled="false"]');return t?t[t.length-1].children[0]:null},findActiveItem:function(){var t=u(this.$refs.nav,'[data-pc-section="item"][data-p-disabled="false"][data-p-active="true"]');return t?t.children[0]:null},setFocusToMenuitem:function(t,n){t.tabIndex="-1",n.tabIndex="0",n.focus()},onTabKey:function(){var t=u(this.$refs.nav,'[data-pc-section="item"][data-p-disabled="false"][data-p-active="true"]'),n=u(this.$refs.nav,'[data-pc-section="itemlink"][tabindex="0"]');n!==t.children[0]&&(t&&(t.children[0].tabIndex="0"),n.tabIndex="-1")},visible:function(t){return typeof t.visible=="function"?t.visible():t.visible!==!1},disabled:function(t){return typeof t.disabled=="function"?t.disabled():t.disabled===!0},label:function(t){return typeof t.label=="function"?t.label():t.label},updateInkBar:function(){for(var t=this.$refs.nav.children,n=!1,r=0;r<t.length;r++){var s=t[r];m(s,"data-p-active")&&(this.$refs.inkbar.style.width=w(s)+"px",this.$refs.inkbar.style.left=p(s).left-p(this.$refs.nav).left+"px",n=!0)}n||(this.$refs.inkbar.style.width="0px",this.$refs.inkbar.style.left="0px")},getMenuItemProps:function(t,n){var r=this;return{action:l({class:this.cx("itemLink"),tabindex:-1,onClick:function(i){return r.onItemClick(i,t,n)},onKeyDown:function(i){return r.onKeydownItem(i,t,n)}},this.getPTOptions("itemLink",t,n)),icon:l({class:[this.cx("itemIcon"),t.icon]},this.getPTOptions("itemIcon",t,n)),label:l({class:this.cx("itemLabel")},this.getPTOptions("itemLabel",t,n))}}},directives:{ripple:x}},O=["aria-labelledby","aria-label"],A=["onClick","onKeydown","data-p-active","data-p-disabled"],_=["href","target","aria-label","aria-disabled"];function z(e,t,n,r,s,i){var k=P("ripple");return d(),c("div",l({class:e.cx("root")},e.ptmi("root")),[f("ul",l({ref:"nav",class:e.cx("tablist"),role:"menubar","aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptm("tablist")),[(d(!0),c(v,null,B(e.model,function(a,o){return d(),c(v,{key:i.label(a)+"_"+o.toString()},[i.visible(a)?(d(),c("li",l({key:0,ref_for:!0,ref:"tab",class:[e.cx("item",{item:a,index:o}),a.class],role:"presentation",onClick:function(b){return i.onItemClick(b,a,o)},onKeydown:function(b){return i.onKeydownItem(b,a,o)}},i.getPTOptions("item",a,o),{"data-p-active":s.d_activeIndex===o,"data-p-disabled":i.disabled(a)}),[e.$slots.item?(d(),g(I(e.$slots.item),{key:1,item:a,index:o,active:o===s.d_activeIndex,label:i.label(a),props:i.getMenuItemProps(a,o)},null,8,["item","index","active","label","props"])):F((d(),c("a",l({key:0,ref_for:!0,ref:"tabLink",role:"menuitem",href:a.url,class:e.cx("itemLink"),target:a.target,"aria-label":i.label(a),"aria-disabled":i.disabled(a),tabindex:-1},i.getPTOptions("itemLink",a,o)),[e.$slots.itemicon?(d(),g(I(e.$slots.itemicon),{key:0,item:a,class:C(e.cx("itemIcon"))},null,8,["item","class"])):a.icon?(d(),c("span",l({key:1,class:[e.cx("itemIcon"),a.icon],ref_for:!0},i.getPTOptions("itemIcon",a,o)),null,16)):h("",!0),f("span",l({class:e.cx("itemLabel"),ref_for:!0},i.getPTOptions("itemLabel",a,o)),M(i.label(a)),17)],16,_)),[[k]])],16,A)):h("",!0)],64)}),128)),f("li",l({ref:"inkbar",role:"none",class:e.cx("activeBar")},e.ptm("activeBar")),null,16)],16,O)],16)}S.render=z;export{S as default};
