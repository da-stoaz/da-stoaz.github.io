import{V as u,ak as f,$ as h,ab as g,c as v,o as c,F as y,h as b,af as l,g as o,T as m,e as k}from"./DqA0wvgn.js";var P=({dt:e})=>`
.p-timeline {
    display: flex;
    flex-grow: 1;
...
`,x={root:function(n){var i=n.props;return["p-timeline p-component","p-timeline-"+i.align,"p-timeline-"+i.layout]},event:"p-timeline-event",eventOpposite:"p-timeline-event-opposite",eventSeparator:"p-timeline-event-separator",eventMarker:"p-timeline-event-marker",eventConnector:"p-timeline-event-connector",eventContent:"p-timeline-event-content"},w=u.extend({name:"timeline",style:P,classes:x}),$={name:"BaseTimeline",extends:f,props:{value:null,align:{mode:String,default:"left"},layout:{mode:String,default:"vertical"},dataKey:null},style:w,provide:function(){return{$pcTimeline:this,$parentInstance:this}}};function p(e){"@babel/helpers - typeof";return p=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(n){return typeof n}:function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},p(e)}function d(e,n,i){return(n=z(n))in e?Object.defineProperty(e,n,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[n]=i,e}function z(e){var n=S(e,"string");return p(n)=="symbol"?n:n+""}function S(e,n){if(p(e)!="object"||!e)return e;var i=e[Symbol.toPrimitive];if(i!==void 0){var s=i.call(e,n);if(p(s)!="object")return s;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(e)}var T={name:"Timeline",extends:$,inheritAttrs:!1,methods:{getKey:function(n,i){return this.dataKey?g(n,this.dataKey):i},getPTOptions:function(n,i){return this.ptm(n,{context:{index:i,count:this.value.length}})}},computed:{dataP:function(){return h(d(d({},this.layout,this.layout),this.align,this.align))}}},O=["data-p"],_=["data-p"],C=["data-p"],K=["data-p"],B=["data-p"],j=["data-p"],F=["data-p"];function M(e,n,i,s,N,t){return c(),v("div",l({class:e.cx("root")},e.ptmi("root"),{"data-p":t.dataP}),[(c(!0),v(y,null,b(e.value,function(a,r){return c(),v("div",l({key:t.getKey(a,r),class:e.cx("event"),ref_for:!0},t.getPTOptions("event",r),{"data-p":t.dataP}),[o("div",l({class:e.cx("eventOpposite",{index:r}),ref_for:!0},t.getPTOptions("eventOpposite",r),{"data-p":t.dataP}),[m(e.$slots,"opposite",{item:a,index:r})],16,C),o("div",l({class:e.cx("eventSeparator"),ref_for:!0},t.getPTOptions("eventSeparator",r),{"data-p":t.dataP}),[m(e.$slots,"marker",{item:a,index:r},function(){return[o("div",l({class:e.cx("eventMarker"),ref_for:!0},t.getPTOptions("eventMarker",r),{"data-p":t.dataP}),null,16,B)]}),r!==e.value.length-1?m(e.$slots,"connector",{key:0,item:a,index:r},function(){return[o("div",l({class:e.cx("eventConnector"),ref_for:!0},t.getPTOptions("eventConnector",r),{"data-p":t.dataP}),null,16,j)]}):k("",!0)],16,K),o("div",l({class:e.cx("eventContent"),ref_for:!0},t.getPTOptions("eventContent",r),{"data-p":t.dataP}),[m(e.$slots,"content",{item:a,index:r})],16,F)],16,_)}),128))],16,O)}T.render=M;export{T as default};
