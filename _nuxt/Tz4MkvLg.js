import{V as v,ak as u,$ as d,c as l,o as e,T as c,j as g,e as f,af as o,t as m,y,E as b}from"./DqA0wvgn.js";var h=({dt:a})=>`
.p-avatar {
    display: inline-flex;
    align-items: center;
...
`,$={root:function(r){var t=r.props;return["p-avatar p-component",{"p-avatar-image":t.image!=null,"p-avatar-circle":t.shape==="circle","p-avatar-lg":t.size==="large","p-avatar-xl":t.size==="xlarge"}]},label:"p-avatar-label",icon:"p-avatar-icon"},z=v.extend({name:"avatar",style:h,classes:$}),S={name:"BaseAvatar",extends:u,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},size:{type:String,default:"normal"},shape:{type:String,default:"square"},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:z,provide:function(){return{$pcAvatar:this,$parentInstance:this}}};function i(a){"@babel/helpers - typeof";return i=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(r){return typeof r}:function(r){return r&&typeof Symbol=="function"&&r.constructor===Symbol&&r!==Symbol.prototype?"symbol":typeof r},i(a)}function p(a,r,t){return(r=w(r))in a?Object.defineProperty(a,r,{value:t,enumerable:!0,configurable:!0,writable:!0}):a[r]=t,a}function w(a){var r=P(a,"string");return i(r)=="symbol"?r:r+""}function P(a,r){if(i(a)!="object"||!a)return a;var t=a[Symbol.toPrimitive];if(t!==void 0){var s=t.call(a,r);if(i(s)!="object")return s;throw new TypeError("@@toPrimitive must return a primitive value.")}return(r==="string"?String:Number)(a)}var k={name:"Avatar",extends:S,inheritAttrs:!1,emits:["error"],methods:{onError:function(r){this.$emit("error",r)}},computed:{dataP:function(){return d(p(p({},this.shape,this.shape),this.size,this.size))}}},E=["aria-labelledby","aria-label","data-p"],j=["data-p"],x=["data-p"],A=["src","alt","data-p"];function B(a,r,t,s,L,n){return e(),l("div",o({class:a.cx("root"),"aria-labelledby":a.ariaLabelledby,"aria-label":a.ariaLabel},a.ptmi("root"),{"data-p":n.dataP}),[c(a.$slots,"default",{},function(){return[a.label?(e(),l("span",o({key:0,class:a.cx("label")},a.ptm("label"),{"data-p":n.dataP}),m(a.label),17,j)):a.$slots.icon?(e(),g(b(a.$slots.icon),{key:1,class:y(a.cx("icon"))},null,8,["class"])):a.icon?(e(),l("span",o({key:2,class:[a.cx("icon"),a.icon]},a.ptm("icon"),{"data-p":n.dataP}),null,16,x)):a.image?(e(),l("img",o({key:3,src:a.image,alt:a.ariaLabel,onError:r[0]||(r[0]=function(){return n.onError&&n.onError.apply(n,arguments)})},a.ptm("image"),{"data-p":n.dataP}),null,16,A)):f("",!0)]})],16,E)}k.render=B;export{k as default};
