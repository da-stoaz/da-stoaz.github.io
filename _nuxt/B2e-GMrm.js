import{s as y}from"./X7vmODOq.js";import{V as A,ar as P,ak as k,af as s,ac as v,c as f,o as d,T as _,F as I,h as C,j as l,w as u,a as g,y as x,e as b,E as p,t as w}from"./DqA0wvgn.js";import S from"./Bofj6Ke8.js";import B from"./DCKa-r0s.js";import N from"./DRyezifl.js";import"./CrqMR_Gz.js";var H=({dt:e})=>`
.p-accordionpanel {
    display: flex;
...
`,E={root:"p-accordion p-component"},D=A.extend({name:"accordion",style:H,classes:E}),F={name:"BaseAccordion",extends:k,props:{value:{type:[String,Number,Array],default:void 0},multiple:{type:Boolean,default:!1},lazy:{type:Boolean,default:!1},tabindex:{type:Number,default:0},selectOnFocus:{type:Boolean,default:!1},expandIcon:{type:String,default:void 0},collapseIcon:{type:String,default:void 0},activeIndex:{type:[Number,Array],default:null}},style:D,provide:function(){return{$pcAccordion:this,$parentInstance:this}}},K={name:"Accordion",extends:F,inheritAttrs:!1,emits:["update:value","update:activeIndex","tab-open","tab-close","tab-click"],data:function(){return{d_value:this.value}},watch:{value:function(o){this.d_value=o},activeIndex:{immediate:!0,handler:function(o){this.hasAccordionTab&&(this.d_value=this.multiple?o==null?void 0:o.map(String):o==null?void 0:o.toString())}}},methods:{isItemActive:function(o){var n;return this.multiple?(n=this.d_value)===null||n===void 0?void 0:n.includes(o):this.d_value===o},updateValue:function(o){var n,t=this.isItemActive(o);this.multiple?t?this.d_value=this.d_value.filter(function(i){return i!==o}):this.d_value?this.d_value.push(o):this.d_value=[o]:this.d_value=t?null:o,this.$emit("update:value",this.d_value),this.$emit("update:activeIndex",this.multiple?(n=this.d_value)===null||n===void 0?void 0:n.map(Number):Number(this.d_value)),this.$emit(t?"tab-close":"tab-open",{originalEvent:void 0,index:Number(o)})},isAccordionTab:function(o){return o.type.name==="AccordionTab"},getTabProp:function(o,n){return o.props?o.props[n]:void 0},getKey:function(o,n){return this.getTabProp(o,"header")||n},getHeaderPT:function(o,n){var t=this;return{root:s({onClick:function(a){return t.onTabClick(a,n)}},this.getTabProp(o,"headerProps"),this.getTabPT(o,"header",n)),toggleicon:s(this.getTabProp(o,"headeractionprops"),this.getTabPT(o,"headeraction",n))}},getContentPT:function(o,n){return{root:s(this.getTabProp(o,"contentProps"),this.getTabPT(o,"toggleablecontent",n)),transition:this.getTabPT(o,"transition",n),content:this.getTabPT(o,"content",n)}},getTabPT:function(o,n,t){var i=this.tabs.length,a={props:o.props||{},parent:{instance:this,props:this.$props,state:this.$data},context:{index:t,count:i,first:t===0,last:t===i-1,active:this.isItemActive("".concat(t))}};return s(this.ptm("accordiontab.".concat(n),a),this.ptmo(this.getTabProp(o,"pt"),n,a))},onTabClick:function(o,n){this.$emit("tab-click",{originalEvent:o,index:n})}},computed:{tabs:function(){var o=this;return this.$slots.default().reduce(function(n,t){return o.isAccordionTab(t)?n.push(t):t.children&&t.children instanceof Array&&t.children.forEach(function(i){o.isAccordionTab(i)&&n.push(i)}),n},[])},hasAccordionTab:function(){return this.tabs.length}},components:{AccordionPanel:N,AccordionHeader:B,AccordionContent:S,ChevronUpIcon:P,ChevronRightIcon:y}};function j(e,o,n,t,i,a){var m=v("AccordionHeader"),$=v("AccordionContent"),T=v("AccordionPanel");return d(),f("div",s({class:e.cx("root")},e.ptmi("root")),[a.hasAccordionTab?(d(!0),f(I,{key:0},C(a.tabs,function(r,c){return d(),l(T,{key:a.getKey(r,c),value:"".concat(c),pt:{root:a.getTabPT(r,"root",c)},disabled:a.getTabProp(r,"disabled")},{default:u(function(){return[g(m,{class:x(a.getTabProp(r,"headerClass")),pt:a.getHeaderPT(r,c)},{toggleicon:u(function(h){return[h.active?(d(),l(p(e.$slots.collapseicon?e.$slots.collapseicon:e.collapseIcon?"span":"ChevronDownIcon"),s({key:0,class:[e.collapseIcon,h.class],"aria-hidden":"true",ref_for:!0},a.getTabPT(r,"headericon",c)),null,16,["class"])):(d(),l(p(e.$slots.expandicon?e.$slots.expandicon:e.expandIcon?"span":"ChevronUpIcon"),s({key:1,class:[e.expandIcon,h.class],"aria-hidden":"true",ref_for:!0},a.getTabPT(r,"headericon",c)),null,16,["class"]))]}),default:u(function(){return[r.children&&r.children.headericon?(d(),l(p(r.children.headericon),{key:0,isTabActive:a.isItemActive("".concat(c)),active:a.isItemActive("".concat(c)),index:c},null,8,["isTabActive","active","index"])):b("",!0),r.props&&r.props.header?(d(),f("span",s({key:1,ref_for:!0},a.getTabPT(r,"headertitle",c)),w(r.props.header),17)):b("",!0),r.children&&r.children.header?(d(),l(p(r.children.header),{key:2})):b("",!0)]}),_:2},1032,["class","pt"]),g($,{pt:a.getContentPT(r,c)},{default:u(function(){return[(d(),l(p(r)))]}),_:2},1032,["pt"])]}),_:2},1032,["value","pt","disabled"])}),128)):_(e.$slots,"default",{key:1})],16)}K.render=j;export{K as default};
