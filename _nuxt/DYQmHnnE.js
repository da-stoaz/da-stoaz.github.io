import{V as a,ak as e,c as l,o as n,T as i,af as o}from"./DqA0wvgn.js";var p=({dt:t})=>`
.p-iftalabel {
    display: block;
    position: relative;
}
...
`,s={root:"p-iftalabel"},r=a.extend({name:"iftalabel",style:p,classes:s}),f={name:"BaseIftaLabel",extends:e,style:r,provide:function(){return{$pcIftaLabel:this,$parentInstance:this}}},b={name:"IftaLabel",extends:f,inheritAttrs:!1};function c(t,d,u,$,m,h){return n(),l("span",o({class:t.cx("root")},t.ptmi("root")),[i(t.$slots,"default")],16)}b.render=c;export{b as default};
