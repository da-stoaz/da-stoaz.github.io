import{V as l,ak as c,bD as d,aB as s,c as t,o as p,T as i,g,af as m}from"./DqA0wvgn.js";var h=({dt:e})=>`
.p-imagecompare {
    position: relative;
    overflow: hidden;
    width: 100%;
...
`,u={root:"p-imagecompare",slider:"p-imagecompare-slider"},b=l.extend({name:"imagecompare",style:h,classes:u}),$={name:"BaseImageCompare",extends:c,props:{tabindex:{type:Number,default:0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:b,provide:function(){return{$pcImageCompare:this,$parentInstance:this}}},f={name:"ImageCompare",extends:$,methods:{onSlide:function(a){var n=a.target.value,o=a.target.previousElementSibling;d(o,s("imagecompare.scope.x").name,"".concat(n,"%"))}}},v=["aria-labelledby","aria-label"];function w(e,a,n,o,y,r){return p(),t("div",m({class:e.cx("root"),"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptmi("root")),[i(e.$slots,"left"),i(e.$slots,"right"),g("input",m({type:"range",min:"0",max:"100",value:"50",onInput:a[0]||(a[0]=function(){return r.onSlide&&r.onSlide.apply(r,arguments)}),class:e.cx("slider")},e.ptm("slider")),null,16)],16,v)}f.render=w;export{f as default};
