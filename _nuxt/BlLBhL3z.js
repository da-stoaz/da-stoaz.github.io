import{V as t,ak as n,c as o,o as p,T as i,af as s}from"./DqA0wvgn.js";var r=({dt:l})=>`
.p-floatlabel {
    display: block;
    position: relative;
}
...
`,b={root:function(e){var a=e.props;return["p-floatlabel",{"p-floatlabel-over":a.variant==="over","p-floatlabel-on":a.variant==="on","p-floatlabel-in":a.variant==="in"}]}},f=t.extend({name:"floatlabel",style:r,classes:b}),u={name:"BaseFloatLabel",extends:n,props:{variant:{type:String,default:"over"}},style:f,provide:function(){return{$pcFloatLabel:this,$parentInstance:this}}},c={name:"FloatLabel",extends:u,inheritAttrs:!1};function d(l,e,a,h,$,v){return p(),o("span",s({class:l.cx("root")},l.ptmi("root")),[i(l.$slots,"default")],16)}c.render=d;export{c as default};
